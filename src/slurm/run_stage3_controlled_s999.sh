...
#SBATCH --output=/projects/prjs2041/logs/stage3_ctrl_s999_%j.out
#SBATCH --error=/projects/prjs2041/logs/stage3_ctrl_s999_%j.err

# Controlled Stage 3 rerun — seed 999, lr0=1e-3 (matches Stage 2).
# Capped at 8 epochs: best T1 collapse occurs at epoch 3 in the
# canonical run; 8 epochs is sufficient to confirm the pattern.
...
echo "=============================="
echo "Stage 3 — CONTROLLED (lr0=1e-3) — seed 999"
