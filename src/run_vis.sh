#!/bin/bash
#SBATCH --job-name=vis_detections
...
#SBATCH --output=/projects/prjs2041/logs/vis_detections_%j.out
#SBATCH --error=/projects/prjs2041/logs/vis_detections_%j.err
...
$PYTHON $UAV_CODE/visualise_detections_rgbt.py \
    ...
    --out-dir   /projects/prjs2041/analysis/stage3_naive/detections \
    --device    0 \
    --no-video
